...
In practice, if we take \Cref{lst:nominatim-geocode} as example, and we decide to map all the users from Italy based on their county, all the users with “Milano, Lombardia” as their original location will be then assigned to “Milano”.