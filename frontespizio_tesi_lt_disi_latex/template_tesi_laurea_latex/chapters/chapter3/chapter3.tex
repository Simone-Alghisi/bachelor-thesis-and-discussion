...
Given the heterogeneity of the tweets, we would also like to conduct a more in-depth analysis, by considering the users, over the whole time frame, based on their gender and also on their location.
