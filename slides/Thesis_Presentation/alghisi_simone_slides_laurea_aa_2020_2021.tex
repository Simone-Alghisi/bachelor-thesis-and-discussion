...
\begin{frame}{Introduction to the problem}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=.35]{assets/img/biden-tweet.jpg}
...
\begin{frame}{Emotion detection}
    ...
    Emotion detection, also called emotion recognition, is the \textbf{process of identifying human emotions}~\autocite{enwiki:1023798177}. To solve this task, it is possible to use lexicon-based techniques, where each word is assigned to a set of zero or more emotions/sentiments.

    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=.35,trim= 0 400 0 10, clip]{assets/img/emotion_detection_example.pdf}
...
\begin{frame}{Dataset description and stats}
	...
	Chen, Lerman, and Ferrara have built an ongoing collection of tweet IDs starting on January 28th, 2020\footnote{echen102/COVID-19-TweetIDs: \url{https://github.com/echen102/COVID-19-TweetIDs}}\textsuperscript{,}~\autocite{chen2020tracking}\text{.}
...
\begin{frame}[fragile]{Users demographics inference}
...
\begin{frame}{Emotions in the English tweets}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=.25]{assets/img/en_5_liwc_categories.svg.pdf}
...
\begin{frame}{Normalized emotions in the English tweets}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=.25]{assets/img/en_4_liwc_categories_standardized.svg.pdf}
...
\begin{frame}{Emotions expressed by men/women in the English tweets}
    ...
    \begin{figure}[H]
	    \centering
    	\includegraphics[scale=.22]{assets/img/en_4_categories_per_gender_over_mean_subplot.svg.pdf}
...
\begin{frame}{Emotions expressed per age in the English tweets}
    ...
    \begin{figure}[H]
	    \centering
    	\includegraphics[scale=.25]{assets/img/en_4_categories_per_age_over_mean_subplot.svg.pdf}
...
\begin{frame}{Emotions expressed in Lombardia from the Italian tweets with events}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=.34]{assets/img/it_4_categories_lombardia_events.svg.pdf}
    	\vspace*{-.75cm}
...
\begin{frame}{Conclusions}
    ...
    \begin{itemize}
    	...
    	\item finally, we were able to notice how, after the discovery of the first coronavirus case, people's anxiety dropped. This probably happened because news and various decrees helped to calm people down.
    \end{itemize}
...
\begin{frame}[plain,noframenumbering]{Emotion in the English tweets (subplots)}
    ...
    \begin{figure}[H]
	    \centering
    	\includegraphics[scale=.25]{assets/img/en_4_liwc_categories_subplots.svg.pdf}
...
\begin{frame}[plain,noframenumbering]{Most used words on 2020/02/24 in the English tweets (LIWC)}
    ...
    \begin{figure}[H]
	    \centering
    	\includegraphics[scale=.25]{assets/img/en_most_used_liwc_words_2020_02_24.svg.pdf}
...
\begin{frame}[plain,noframenumbering]{Emotions expressed in Lombardia from the Italian tweets}
    ...
    \begin{figure}[H]
    	\centering
    	\includegraphics[scale=.25]{assets/img/it_4_categories_lombardia_standardized.svg.pdf}
